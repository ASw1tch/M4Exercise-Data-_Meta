...
extension Dish : Identifiable {
    ...
    static func with(name: String,
        ...
        do {
            ...
            print("with \(error.localizedDescription)")
            return nil
        }
    }
    ...
    class func deleteAll(_ context:NSManagedObjectContext) {
        ...
        do {
            ...
            print("delete all \(error.localizedDescription)")
        }
    }
    ...
    static func exists(name: String,
        ...
        do {
            ...
            print("exist \(error.localizedDescription)")
            return false
        }
    }
    ...
    class func readAll(_ context:NSManagedObjectContext) -> [Dish]? {
        ...
        do {
            ...
            print("readAll \(error.localizedDescription)")
            return nil
        }
    }
